...
void benchmark_mat_cdiv(DevicePtr const &device, Tensor &a, Tensor &b)
...
int main()
{
  ...
  benchmark_mat_cdiv(serial_device, a, b);
  benchmark_mat_cdiv(eigen_device, a, b);
  benchmark_mat_cdiv(simd_device, a, b);
  benchmark_mat_cdiv(metal_device, a, b);
