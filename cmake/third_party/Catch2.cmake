...
if(NOT TARGET Catch2::Catch2WithMain)
  ...
  if(EXISTS "${THIRD_PARTY_DIR}/catch2-src")
    message(STATUS
      "GPU Playground: "
      "Found Catch2 installed in ${THIRD_PARTY_DIR}/catch2-src"
    )
    add_subdirectory(
      "${THIRD_PARTY_DIR}/catch2-src"
      "${THIRD_PARTY_DIR}/catch2-build"
    )
  else()
    message(STATUS "GPU Playground: "
...
if(NOT DEFINED CATCH2_SOURCE_DIR)
  message(FATAL_ERROR "GPU Playground: Could not find Catch2 source directory")
endif()
