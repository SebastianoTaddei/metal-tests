...
void test_mat_cmul(DevicePtr const &device, Tensor &a, Tensor &b)
{
  a.to(device);
  b.to(device);
...
int main()
{
  ...
  test_mat_cmul(serial_device, a, b);
  test_mat_cmul(eigen_device, a, b);
  test_mat_cmul(simd_device, a, b);
  test_mat_cmul(metal_device, a, b);
